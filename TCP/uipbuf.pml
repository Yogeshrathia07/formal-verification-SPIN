...
proctype uipbuf_set_len(){
    printf(" uipbuf : uipbuf_set_len\n");
}
// -----------------------------------------
proctype uipbuf_set_len_field(){
    printf(" uipbuf : uipbuf_set_len_field\n");
}
// -----------------------------------------
proctype uipbuf_get_len_field(){
    printf(" uipbuf : uipbuf_get_len_field\n");
}
// -----------------------------------------
proctype uip_is_proto_ext_hdr(){
    printf(" uipbuf : uip_is_proto_ext_hdr\n");
}
proctype uipbuf_get_next_header(){
    printf(" uipbuf : uipbuf_get_next_header\n");
    run uip_is_proto_ext_hdr();
}
// -----------------------------------------
proctype uipbuf_get_last_header(){
    printf(" uipbuf : uipbuf_get_last_header\n");
    run uipbuf_get_next_header();
}
// -----------------------------------------
proctype uipbuf_search_header(){
    printf(" uipbuf : uipbuf_search_header\n");
    run uipbuf_get_next_header();
}
// -----------------------------------------
proctype uipbuf_get_attr(){
    printf(" uipbuf : uipbuf_get_attr\n");
}
proctype uipbuf_set_attr(){
    printf(" uipbuf : uipbuf_set_attr\n");
}
// -----------------------------------------
proctype uipbuf_set_default_attr(){
    printf(" uipbuf : uipbuf_set_default_attr\n");
}
// -----------------------------------------
proctype uipbuf_set_attr_flag(){
    printf(" uipbuf : uipbuf_set_attr_flag\n");
}
// -----------------------------------------
proctype uipbuf_clr_attr_flag(){
    printf(" uipbuf : uipbuf_clr_attr_flag\n");
}
// -----------------------------------------
proctype uipbuf_is_attr_flag(){
    printf(" uipbuf : uipbuf_is_attr_flag\n");
}
// -----------------------------------------
proctype uipbuf_init(){
    printf(" uipbuf : uipbuf_init\n");
